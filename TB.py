...
def do_zip_update():
    ...
    if success:
        ...
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/MR-TIOX/TIOX-SMS-BD")
...
def do_git_update():
    ...
    if success:
        ...
        mesgdcrt.FailureMessage("Unable to update TIOX-Bomb.")
        mesgdcrt.WarningMessage("Make Sure To Install 'git' ")
        mesgdcrt.GeneralMessage("Then run command:")
        print(
            "git checkout . && "
            "git pull https://github.com/MR-TIOX/TIOX-SMS-BD HEAD")
    sys.exit()
...
def check_for_updates():
    ...
    fver = requests.get(
        "https://github.com/MR-TIOX/TIOX-SMS-BD/blob/main/.version"
    ).text.strip()
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("TIOX-Bomb is up-to-date")
        mesgdcrt.GeneralMessage("Starting TIOX-Bomb")


def notifyen():
    try:
        if DEBUG_MODE:
            url = "https://github.com/MR-TIOX/TIOX-SMS-BD/blob/main/.notify"
        else:
            url = "https://github.com/MR-TIOX/TIOX-SMS-BD/blob/main/.notify"
...
if sys.version_info[0] != 3:
    mesgdcrt.FailureMessage("TIOX-Bomb will work only in Python v3")
    sys.exit()
...
__CONTRIBUTORS__ = ['SpeedX', 't0xic0der', 'scpketer', 'MR-TIOX']
